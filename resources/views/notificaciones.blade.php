  ...
  ref.on("value", function(snapshot) {
   ...
   for(var i=0;i < snapshot.val().usuarios.length; i++){
        ...
        for(var j=0;j < notificacion.length; j++){
            ...
            var nota = '<li class="list-group-item d-flex align-items-center"><img id="icono" src="images/'+icono+'.png" alt="'+icono+'"><span class="text">'+texto+'</span><span class="badge badge-primary badge-pill">1</span><h5 style="font-size:10px;margin-left:10px;margin-top:11px;">'+fecha+'</h5></li>'
...
<div class="container-fluid notificaciones">
    ...
    <ul class="list-group notificaciones-lista">
        ...
        <!--<li class="list-group-item d-flex align-items-center">
            <img id="icono" src="images/urgente.png" alt="Urgente">
            <span class="text">
